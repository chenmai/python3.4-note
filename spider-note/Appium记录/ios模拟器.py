...
desired_caps['app'] = os.path.abspath('/Users/duomai/Desktop/appium/haiuser 2016-07-12 11-17-32/haiuser.ipa')
...
#     点击热搜第三个,mandy
    wd.implicitly_wait(5)
    wd.find_element_by_xpath("//UIAApplication[1]/UIAWindow[1]/UIATableView[1]/UIATableCell[2]/UIAButton[3]").click()
#     全部宝贝第一个商品
    wd.implicitly_wait(5)
